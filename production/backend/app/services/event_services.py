...
class EventService:
    ...
    async def broadcast(self, event_type: str, data: Any, session_ids: list[str] = None) -> None:
    ...
    async def broadcast_log(self, level: str, message:str, session_ids: list[str] = None) -> None:
    ...
    async def broadcast_vehicle(self, side: str, info: Dict, session_ids: list[str] = None) -> None:
